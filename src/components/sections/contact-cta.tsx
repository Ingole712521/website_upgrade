          ...
          >
            ...
            <div className="relative grid items-center gap-8 p-8 sm:p-10 lg:grid-cols-[1.2fr_0.8fr] lg:gap-12 lg:p-12">
              ...
              >
                ...
                <motion.span
                  variants={staggerItem}
                  className="mt-10 inline-flex h-12 items-center gap-2 rounded-xl bg-primary px-5 text-sm font-medium text-primary-foreground shadow-[0_10px_30px_-12px_rgba(58,174,240,0.7)]"
                >
                  Go to Contact Us
